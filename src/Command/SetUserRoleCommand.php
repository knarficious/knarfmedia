...
{
    protected static $defaultName = 'app:set-user-role';
    ...
    {
        $this
        ->setDescription('Set User\'s Role and update the database')
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->io->title('Set User Role Command Interactive Wizard');
        $this->io->text([
            'If you prefer to not use this interactive wizard, provide the',
            'arguments required by this command as follows:',
            '',
            ' $ php bin/console app:set-user-role username role',
            '',
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $stopWatch->start('set-user-role-command');
        ...
        $event = $stopWatch->stop('set-user-role-command');
        if ($output->isVerbose()) {
