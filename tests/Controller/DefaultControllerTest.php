...
class DefaultControllerTest extends WebTestCase
{
    ...
    public function testPublicBlogPost(): void
    {
        ...
        $client->request('GET', sprintf('/fr/blog/posts/%s', $blogPost->getSlug()));
    ...
    public function testSecureUrls(string $url): void
    {
        ...
        $this->assertResponseRedirects(
            'https://knarfmedia.fr.local/fr/login',
            Response::HTTP_FOUND,
    ...
    {
        yield ['/fr/admin/posts/'];
        yield ['/fr/admin/posts/new'];
        yield ['/fr/admin/posts/1'];
        yield ['/fr/admin/posts/1/edit'];
    }
}
